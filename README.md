...
Enhanced mode is available for S3-to-S3 transfers (same-account and cross-account). See the [DataSync Task Module documentation](modules/datasync-task/) for detailed requirements and considerations.
